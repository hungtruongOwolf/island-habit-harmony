...
export const TopBar = () => (
  <div className="absolute top-0 left-0 right-0 z-30 flex items-start justify-between p-4 pointer-events-none">
    {/* Top-left: Island identity + party */}
    <div className="flex flex-col gap-2 pointer-events-auto">
      <div className="hud-panel-dark px-3 py-2 flex items-center gap-3">
        ...
        <div className="border-l border-white/15 pl-3 flex items-center gap-1.5 text-[11px]">
          ...
          <span className="font-bold opacity-80">Lv. 14</span>
        </div>
      </div>
      ...
      <div className="hud-panel px-2.5 py-1.5 flex items-center gap-2">
        ...
        <span className="text-[11px] font-bold text-foreground pl-1">4/5</span>
        <ChevronDown className="h-3.5 w-3.5 text-muted-foreground" />
      </div>
    </div>

    {/* Top-right: Resources + day cycle + system */}
    <div className="flex flex-col items-end gap-2 pointer-events-auto">
      ...
      <div className="flex items-center gap-2">
        <div className="resource-pill">
          ...
          <span className="text-sm">2,486</span>
          <span className="text-[10px] text-primary/80 font-bold ml-1">+128</span>
        </div>
        <div className="resource-pill">
          ...
          <span className="text-sm">12<span className="text-[10px] opacity-70 font-semibold">d</span></span>
        </div>
      </div>
    </div>
  </div>
